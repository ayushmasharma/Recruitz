...
class AddRoundActivity : BaseActivity() {
    ...
    private fun addRound(){
        ...
        if (validateForm(
            ...
            Firestore().addRoundInCompany(round,company.name, collegeCode, this)
        }
    }
    ...
    fun addRoundInCompanySuccess(){
        ...
        Firestore().getStudentsFromIds(eligibleStudentsIds,this)
    }
    ...
    fun getStudentsFromIdsSuccess(students: ArrayList<Student>){
        ...
        Firestore().updateCompanyInStudentDatabase(
